...
public class CardboardStartup : MonoBehaviour {
    ...
    private RuntimeXRLoaderManager runtimeXRLoaderManager;
    ...
    public void Start() {
        ...
        sceneJumpManager = GetComponent<SceneJumpManager>();
        runtimeXRLoaderManager = FindObjectOfType<RuntimeXRLoaderManager>().GetComponent<RuntimeXRLoaderManager>();
    ...
    public void Update() {
        if (_isVrModeEnabled) {
            if (Api.IsCloseButtonPressed) {
                ExitVR();
                sceneJumpManager.InternalLoadScene("Lobby");
            }
