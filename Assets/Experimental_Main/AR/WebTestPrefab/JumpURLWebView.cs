...
public class JumpURLWebView : MonoBehaviour
{
    [SerializeField]
    private TextMeshProUGUI status;
    //[SerializeField]
    //private Button closeWebViewBtn;
    //[SerializeField]
    //private Image bg, bgLogo;
    ...
    private void Start() {
        ...
        //closeWebViewBtn.enabled = false;
        this.GoUrl("");
        //bg.enabled = false;
        //bgLogo.enabled = false;
    }
    ...
    public void GoUrl(string url) {
        this.Url = GameManager.Instance.currentURL;
    ...
    IEnumerator StartWebView() {
        if (Url == null) {
            Url = "https://www.youtube.com/watch?v=kqvFSrO-iAg";
        }

        //closeWebViewBtn.enabled = true;
        //bg.enabled = true;
        //bgLogo.enabled = true;
        ...
        webViewObject.SetMargins(0, Screen.height/6, 0, 0);
    ...
    void OnGUI() {
        ...
        //    GUI.enabled = webViewObject.enabled;
        //    GUI.depth = 100;
        //    if (GUI.Button(new Rect(Screen.width / 20, Screen.width / 20, Screen.width / 10, Screen.width / 10), "X")) {
        //        var g = GameObject.Find("WebViewObject");
        //        if (g != null) {
        //            Destroy(g);
        //            GUI.depth = 0;
